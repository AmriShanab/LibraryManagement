...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/Immortal-Life-of-Henrietta-Lacks.jpg')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/educated.jpeg')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/glass.webp')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/into the wild.webp')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/quiet.jpeg')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/wright brothers.jpg')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/michelle-obama-2-28d967730dfd4825bf67f8bf61310ce9.jpg')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="{{asset('images/diry of young girl.webp')}}" class="card-img-top" alt="Book Cover">
                <div class="card-body">
