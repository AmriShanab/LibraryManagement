...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/to kill a mocking bird.webp" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/Pride-and-Prejudice3.webp" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/catcher in the rye.jpeg" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/animal farm 2.jpg" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/Brave-new-2048x2048_grande.webp" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/Book_cover.jpeg" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/frankenstein_cover-print.jpg" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/great.webp" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="../../Assets/Images/1994.webp" class="card-img-top fixed-size-img" alt="Book Cover">
                <div class="card-body">
