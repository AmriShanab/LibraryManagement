    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/brief.jpeg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/origin2.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/cosmos.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/selfish.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/silent-spring-first-edition-signed-rare-2.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/The-Sixth-Extinction-An-Unnatural-History-by-Elizabeth-Kolbert.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/guns2.jpeg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/treees.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
