    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/harry2.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/Chocolatefactory-600x600.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/The+Lion,+the+Witch,+and+the+Wardrobe.jpeg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/matilda.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/winnie-book_1024x1024.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/cat.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/where-the-wild-things-are-activities-interactive-read-aloud-1024x1024.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/alice-in-wonderland-manuscript.jpg" class="card-img-top" alt="Book Cover">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card books">
                <img src="../../Assets/Images/ai.webp" class="card-img-top" alt="Book Cover">
                <div class="card-body">
